...
export const AdminTicketList: React.FC<AdminTicketListProps> = ({
  ...
  const awaitingAdminManager = filteredTickets.filter(
    (t) => t.status === "awaiting_admin_manager",
  ).length;
  const awaitingMaterials = filteredTickets.filter(
    (t) => t.status === "awaiting_materials",
  ).length;
  const awaitingTechnician = filteredTickets.filter(
    (t) => t.status === "awaiting_technician",
  ).length;
    ...
    <div>
      ...
      >
        ...
        {(currentUser.role === "manager" ||
          ...
          <button
            id="btn-raise-admin-ticket-list"
