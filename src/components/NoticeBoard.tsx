...
export const NoticeBoard: React.FC<NoticeBoardProps> = ({
  ...
  const sortedNotices = [
    ...(isAdmin && activeTab === "archive" ? archivedNotices : activeNotices),
  ].sort((a, b) => {
        ...
        {sortedNotices.map((notice) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                isAdmin && onEditNoticeClick && onEditNoticeClick(notice.id)
              }
            >
              ...
              <div className="notice-footer">
                ...
                {isAdmin && onEditNoticeClick && (
                  <span
                    style={{ color: "var(--color-primary-solid, #3b82f6)" }}
                  >
                    Click to edit notice
                  </span>
                )}
              </div>
            </div>
