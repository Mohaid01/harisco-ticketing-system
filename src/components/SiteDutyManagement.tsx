...
import type { AppUser, SiteDutyApplication, LeaveStatus } from "../types";
import { formatEmployeeCode } from "../utils";
import { MapPin, CheckCircle, Clock, XCircle, Plus, X } from "lucide-react";
...
export const SiteDutyManagement: React.FC<SiteDutyManagementProps> = ({
  currentUser,
  token,
}) => {
