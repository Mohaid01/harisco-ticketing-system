...
router.get(
  "/",
  authenticateToken,
  async (req: AuthRequest, res: ApiResponse<LeavesResponse>) => {
...
router.post(
  ...
  authenticateToken,
  async (
    req: ApiAuthRequest<CreateLeaveRequestBody>,
    res: ApiResponse<CreateLeaveResponse>,
  ) => {
...
router.put(
  ...
  authenticateToken,
  async (
    req: ApiAuthRequest<UpdateLeaveStatusRequestBody>,
    res: ApiResponse<UpdateLeaveStatusResponse>,
  ) => {
    const db = getDb();
